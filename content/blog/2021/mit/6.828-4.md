...
page table 其实就是一个列表，存储着所有页（page）。GDB 查看 entry_pgtable（页表的变量）的值如下：
```shell
(gdb) p entry_pgtable
$14 = {3, 4099, 8195, 12291, 16387, 20483, 24579, 28675, 32771, 36867, 40963, 45059, 49155, 53251, 57347, 61443, 65539, 69635, 73731, 77827, 
  81923, 86019, 90115, 94211, 98307, 102403, 106499, 110595, 114691, 118787, 122883, 126979, 131075, 135171, 139267, 143363, 147459, 151555, 
  155651, 159747, 163843, 167939, 172035, 176131, 180227, 184323, 188419, 192515, 196611, 200707, 204803, 208899, 212995, 217091, 221187, 
  225283, 229379, 233475, 237571, 241667, 245763, 249859, 253955, 258051, 262147, 266243, 270339, 274435, 278531, 282627, 286723, 290819, 
  294915, 299011, 303107, 307203, 311299, 315395, 319491, 323587, 327683, 331779, 335875, 339971, 344067, 348163, 352259, 356355, 360451, 
  364547, 368643, 372739, 376835, 380931, 385027, 389123, 393219, 397315, 401411, 405507, 409603, 413699, 417795, 421891, 425987, 430083, 
  434179, 438275, 442371, 446467, 450563, 454659, 458755, 462851, 466947, 471043, 475139, 479235, 483331, 487427, 491523, 495619, 499715, 
  503811, 507907, 512003, 516099, 520195, 524291, 528387, 532483, 536579, 540675, 544771, 548867, 552963, 557059, 561155, 565251, 569347, 
  573443, 577539, 581635, 585731, 589827, 593923, 598019, 602115, 606211, 610307, 614403, 618499, 622595, 626691, 630787, 634883, 638979, 
  643075, 647171, 651267, 655363, 659459, 663555, 667651, 671747, 675843, 679939, 684035, 688131, 692227, 696323, 700419, 704515, 708611, 
  712707, 716803, 720899, 724995, 729091, 733187, 737283, 741379, 745475, 749571, 753763, 757763, 761859, 765955, 770051, 774147, 778243, 
  782339, 786435, 790531, 794627, 798723, 802819, 806915, 811011, 815107...}
```
...
ULIM, MMIOBASE -->  +------------------------------+ 0xef800000         ======> 分界线，上面全部是内核空间
                    |  Cur. Page Table (User R-)   | R-/R-  PTSIZE               |
   UVPT      ---->  +------------------------------+ 0xef400000                  |
                    |          RO PAGES            | R-/R-  PTSIZE               |===> 中间区域内核和用户权限一致
   UPAGES    ---->  +------------------------------+ 0xef000000                  |
                    |           RO ENVS            | R-/R-  PTSIZE               |
UTOP,UENVS ------>  +------------------------------+ 0xeec00000         ======> 分界线，下面全部是用户空间
